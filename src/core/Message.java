...
public class Message implements Comparable<Message> {
	...
	private boolean isIndirectRREP = false;
	private String	appID;
	/** 0 - normal message, generated by the simulator
	 *  1 - RREQ
	 *  2 - RREP */
	public static final int DATA = 0;

	public static final int RREQ = 1;
	public static final int RREQ_SIZE = 64;
	public static final int RREP = 2;
	public static final int RREP_SIZE = 64;
	private int type = 0;
	/**
	 * int requestId used only for RREQs
	...
	public Message(DTNHost from, DTNHost to, String id, int size, int type, int requestId) {
	...
	public int getHopCount() {
		if (this.isIndirectRREP) {
			return this.indirectRREPHopCount;
		}
		return this.path.size() - 1;
	}
	/**
	 * This is a hack to omit the problem with the hopCount in the RREPs generated by
	 * not-end-of-the-route nodes. That types of messages will have isIndirectRREP set to true
	 * and will have explicit hopCount counter
	 */
	private int indirectRREPHopCount = -1;
	public void setIndirectRREPHopCount(int hopCount) {
		this.isIndirectRREP = true;
		this.indirectRREPHopCount = hopCount;
	}
	...
	protected void copyFrom(Message m) {
		...
		this.appID = m.appID;
		this.type = m.type;
		this.indirectRREPHopCount = m.indirectRREPHopCount;
		this.isIndirectRREP = m.isIndirectRREP;
